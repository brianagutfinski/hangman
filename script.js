...
//start pseudcode because I don't know what I'm doing//

//ascertain player's identity

//ask player to click  guess button
...
(function () {
    ...
    function setup() {
        ...
        lives = 5;
        words = ["perm", "radical", "Madonna", "Spandex", "Berlin Wall"];
        messages = {
            win: 'You win!',
            lose: 'Game over!',
